  ...
  return <MotionConfig reducedMotion="user">
    <div className="page">
      <main id="main">
        ...
        <div className="bookmarks">{groups.length ? groups.map((group, index) => <GroupSection key={group.name} group={group} index={index} />) : <p className="empty-state">还没有书签，先搜索想去的地方吧。</p>}</div>
      </main>
    </div>
  </MotionConfig>
}
